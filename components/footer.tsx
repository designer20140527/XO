...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 border-t border-white/10 mt-16">
      <div className="max-width-container px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* Logo and info */}
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <Image src="/images/logo-transparent.png" alt="XO Logo" width={50} height={50} />
              <span className="text-3xl font-bold font-montserrat">XO</span>
            </div>
            <p className="text-gray-400 font-poppins max-w-xs">
              The celestial battlefield where each mark shapes the destiny of worlds.
            </p>
            <div className="flex items-center gap-5">
              <Link
                href="https://t.me/XO_Portal"
                target="_blank"
          ...
          <div className="md:text-right">
            <h3 className="text-xl font-bold mb-6 font-montserrat">Navigation</h3>
            <ul className="space-y-4 font-poppins">
              <li>
                <button 
                  onClick={() => scrollToSection('top')} 
                  className="text-gray-400 hover:text-[#1cc9f2] transition-colors"
                >
                  Home
                </button>
              </li>
              ...
              <li>
                <button 
                  onClick={() => scrollToSection('path-section')} 
                  className="text-gray-400 hover:text-[#1cc9f2] transition-colors"
                >
                  Features
                </button>
        ...
        {/* Copyright */}
        <div className="border-t border-white/10 mt-12 pt-8 text-center text-gray-500 font-poppins">
          <p>© {currentYear} XO. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
